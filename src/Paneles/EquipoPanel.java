...
public class EquipoPanel extends javax.swing.JPanel{
    ...
    public EquipoPanel(JFrame frame,JPanel p,Gestionador gesEvento) {
        initComponents();
        this.frame = frame;
        this.gesEvento = gesEvento;
        panelAgregarPanel = new EquipoAgregarPanel(this.gesEvento);
        panelGestionarEquipo = new EquipoGestionarPanel(frame,this.gesEvento,p);
        panel = p;
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        cambiarPanel(panelGestionarEquipo);
        panelGestionarEquipo.actualizarTablaMostrar();
        panelGestionarEquipo.revalidate();
        panelGestionarEquipo.repaint();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        cambiarPanel(panelAgregarPanel);
